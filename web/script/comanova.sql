...
--
-- Host: localhost
-- Generation Time: Jul 03, 2009 at 02:55 PM
...
--
-- Table structure for table `com_banner`
--

CREATE TABLE IF NOT EXISTS `com_banner` (
...
--
-- Dumping data for table `com_banner`
--

INSERT INTO `com_banner` (`bid`, `cid`, `type`, `name`, `alias`, `imptotal`, `impmade`, `clicks`, `imageurl`, `clickurl`, `date`, `showBanner`, `checked_out`, `checked_out_time`, `editor`, `custombannercode`, `catid`, `description`, `sticky`, `ordering`, `publish_up`, `publish_down`, `tags`, `params`) VALUES
...
(3, 1, '', 'Joomla!', 'joomla', 0, 31, 0, '', 'http://www.joomla.org', '2006-05-29 14:21:28', 1, 0, '0000-00-00 00:00:00', '', '<a href="{CLICKURL}" target="_blank">{NAME}</a>\r\n<br/>\r\nJoomla! The most popular and widely used Open Source CMS Project in the world.', 14, '', 0, 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', ''),
(4, 1, '', 'JoomlaCode', 'joomlacode', 0, 31, 0, '', 'http://joomlacode.org', '2006-05-29 14:19:26', 1, 0, '0000-00-00 00:00:00', '', '<a href="{CLICKURL}" target="_blank">{NAME}</a>\r\n<br/>\r\nJoomlaCode, development and distribution made easy.', 14, '', 0, 2, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', ''),
(5, 1, '', 'Joomla! Extensions', 'joomla-extensions', 0, 26, 0, '', 'http://extensions.joomla.org', '2006-05-29 14:23:21', 1, 0, '0000-00-00 00:00:00', '', '<a href="{CLICKURL}" target="_blank">{NAME}</a>\r\n<br/>\r\nJoomla! Components, Modules, Plugins and Languages by the bucket load.', 14, '', 0, 3, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', ''),
(6, 1, '', 'Joomla! Shop', 'joomla-shop', 0, 26, 0, '', 'http://shop.joomla.org', '2006-05-29 14:23:21', 1, 0, '0000-00-00 00:00:00', '', '<a href="{CLICKURL}" target="_blank">{NAME}</a>\r\n<br/>\r\nFor all your Joomla! merchandise.', 14, '', 0, 4, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '', ''),
...
--
-- Table structure for table `com_bannerclient`
--

CREATE TABLE IF NOT EXISTS `com_bannerclient` (
...
--
-- Dumping data for table `com_bannerclient`
--

INSERT INTO `com_bannerclient` (`cid`, `name`, `contact`, `email`, `extrainfo`, `checked_out`, `checked_out_time`, `editor`) VALUES
(1, 'Open Source Matters', 'Administrator', 'admin@opensourcematters.org', '', 0, '00:00:00', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `com_bannertrack`
--

CREATE TABLE IF NOT EXISTS `com_bannertrack` (
...
--
-- Dumping data for table `com_bannertrack`
--
...
INSERT INTO `com_categories` (`id`, `parent_id`, `title`, `name`, `alias`, `image`, `section`, `image_position`, `description`, `published`, `checked_out`, `checked_out_time`, `editor`, `ordering`, `access`, `count`, `params`) VALUES
...
CREATE TABLE IF NOT EXISTS `com_components` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `com_components` (`id`, `name`, `link`, `menuid`, `parent`, `admin_menu_link`, `admin_menu_alt`, `option`, `ordering`, `admin_menu_img`, `iscore`, `params`, `enabled`) VALUES
...
--
-- Table structure for table `com_contact_details`
--

CREATE TABLE IF NOT EXISTS `com_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `com_contact_details`
--

INSERT INTO `com_contact_details` (`id`, `name`, `alias`, `con_position`, `address`, `suburb`, `state`, `country`, `postcode`, `telephone`, `fax`, `misc`, `image`, `imagepos`, `email_to`, `default_con`, `published`, `checked_out`, `checked_out_time`, `ordering`, `params`, `user_id`, `catid`, `access`, `mobile`, `webpage`) VALUES
...
--
-- Table structure for table `com_content`
--

CREATE TABLE IF NOT EXISTS `com_content` (
...
--
-- Dumping data for table `com_content`
--

INSERT INTO `com_content` (`id`, `title`, `alias`, `title_alias`, `introtext`, `fulltext`, `state`, `sectionid`, `mask`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `parentid`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`) VALUES
...
--
-- Table structure for table `com_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `com_content_frontpage` (
...
--
-- Dumping data for table `com_content_frontpage`
--

INSERT INTO `com_content_frontpage` (`content_id`, `ordering`) VALUES
(45, 2),
(6, 3),
(44, 4),
(5, 5),
...
--
-- Table structure for table `com_content_rating`
--

CREATE TABLE IF NOT EXISTS `com_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `com_content_rating`
--
...
--
-- Table structure for table `com_core_acl_aro`
--

CREATE TABLE IF NOT EXISTS `com_core_acl_aro` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `com_section_value_value_aro` (`section_value`(100),`value`(100)),
  KEY `com_gacl_hidden_aro` (`hidden`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=11 ;

--
-- Dumping data for table `com_core_acl_aro`
--

INSERT INTO `com_core_acl_aro` (`id`, `section_value`, `value`, `order_value`, `name`, `hidden`) VALUES
(10, 'users', '62', 0, 'Administrator', 0);

-- --------------------------------------------------------

--
-- Table structure for table `com_core_acl_aro_groups`
--

CREATE TABLE IF NOT EXISTS `com_core_acl_aro_groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parent_id` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`id`),
  KEY `com_gacl_parent_id_aro_groups` (`parent_id`),
  KEY `com_gacl_lft_rgt_aro_groups` (`lft`,`rgt`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=31 ;

--
-- Dumping data for table `com_core_acl_aro_groups`
--

INSERT INTO `com_core_acl_aro_groups` (`id`, `parent_id`, `name`, `lft`, `rgt`, `value`) VALUES
(17, 0, 'ROOT', 1, 22, 'ROOT'),
...
--
-- Table structure for table `com_core_acl_aro_map`
--

CREATE TABLE IF NOT EXISTS `com_core_acl_aro_map` (
...
--
-- Dumping data for table `com_core_acl_aro_map`
--
...
--
-- Table structure for table `com_core_acl_aro_sections`
--

CREATE TABLE IF NOT EXISTS `com_core_acl_aro_sections` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `hidden` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `com_gacl_value_aro_sections` (`value`),
  KEY `com_gacl_hidden_aro_sections` (`hidden`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=11 ;

--
-- Dumping data for table `com_core_acl_aro_sections`
--

INSERT INTO `com_core_acl_aro_sections` (`id`, `value`, `order_value`, `name`, `hidden`) VALUES
(10, 'users', 1, 'Users', 0);

-- --------------------------------------------------------

--
-- Table structure for table `com_core_acl_groups_aro_map`
--

CREATE TABLE IF NOT EXISTS `com_core_acl_groups_aro_map` (
...
--
-- Dumping data for table `com_core_acl_groups_aro_map`
--

INSERT INTO `com_core_acl_groups_aro_map` (`group_id`, `section_value`, `aro_id`) VALUES
(25, '', 10);

-- --------------------------------------------------------

--
-- Table structure for table `com_core_log_items`
--

CREATE TABLE IF NOT EXISTS `com_core_log_items` (
...
--
-- Dumping data for table `com_core_log_items`
--
...
--
-- Table structure for table `com_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `com_core_log_searches` (
  `search_term` varchar(128) NOT NULL DEFAULT '',
  `hits` int(11) unsigned NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

--
-- Dumping data for table `com_core_log_searches`
--
...
INSERT INTO `com_menu` (`id`, `menutype`, `name`, `alias`, `link`, `type`, `published`, `parent`, `componentid`, `sublevel`, `ordering`, `checked_out`, `checked_out_time`, `pollid`, `browserNav`, `access`, `utaccess`, `params`, `lft`, `rgt`, `home`) VALUES
...
--
-- Table structure for table `com_menu_types`
--

CREATE TABLE IF NOT EXISTS `com_menu_types` (
...
--
-- Dumping data for table `com_menu_types`
--

INSERT INTO `com_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
...
CREATE TABLE IF NOT EXISTS `com_messages` (
...
--
-- Table structure for table `com_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `com_messages_cfg` (
...
--
-- Dumping data for table `com_messages_cfg`
--
...
--
-- Table structure for table `com_migration_backlinks`
--

CREATE TABLE IF NOT EXISTS `com_migration_backlinks` (
...
--
-- Dumping data for table `com_migration_backlinks`
--
...
INSERT INTO `com_modules` (`id`, `title`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `published`, `module`, `numnews`, `access`, `showtitle`, `params`, `iscore`, `client_id`, `control`) VALUES
...
(24, 'Sections', '', 10, 'left', 0, '0000-00-00 00:00:00', 1, 'mod_sections', 0, 0, 1, 'cache=1', 1, 0, ''),
...
(43, 'Login', '', 14, 'left', 0, '0000-00-00 00:00:00', 1, 'mod_login', 0, 0, 1, 'cache=0\nmoduleclass_sfx=\npretext=\nposttext=\nlogin=\nlogout=\ngreeting=1\nname=0\nusesecure=0\n\n', 0, 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `com_modules_menu`
--

CREATE TABLE IF NOT EXISTS `com_modules_menu` (
...
--
-- Dumping data for table `com_modules_menu`
--

INSERT INTO `com_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(16, 1),
(17, 0),
(18, 1),
...
--
-- Table structure for table `com_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `com_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` text NOT NULL,
  `alias` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `com_newsfeeds`
--

INSERT INTO `com_newsfeeds` (`catid`, `id`, `name`, `alias`, `link`, `filename`, `published`, `numarticles`, `cache_time`, `checked_out`, `checked_out_time`, `ordering`, `rtl`) VALUES
...
--
-- Table structure for table `com_plugins`
--

CREATE TABLE IF NOT EXISTS `com_plugins` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `com_plugins`
--

INSERT INTO `com_plugins` (`id`, `name`, `element`, `folder`, `access`, `ordering`, `published`, `iscore`, `client_id`, `checked_out`, `checked_out_time`, `params`) VALUES
...
--
-- Dumping data for table `com_polls`
--

INSERT INTO `com_polls` (`id`, `title`, `alias`, `voters`, `checked_out`, `checked_out_time`, `published`, `access`, `lag`) VALUES
(14, 'Joomla! is used for?', 'joomla-is-used-for', 11, 0, '0000-00-00 00:00:00', 1, 0, 86400);

-- --------------------------------------------------------

--
-- Table structure for table `com_poll_data`
--

CREATE TABLE IF NOT EXISTS `com_poll_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pollid` int(11) NOT NULL DEFAULT '0',
  `text` text NOT NULL,
...
--
-- Dumping data for table `com_poll_data`
--

INSERT INTO `com_poll_data` (`id`, `pollid`, `text`, `hits`) VALUES
...
--
-- Table structure for table `com_poll_date`
--

CREATE TABLE IF NOT EXISTS `com_poll_date` (
...
--
-- Dumping data for table `com_poll_date`
--

INSERT INTO `com_poll_date` (`id`, `date`, `vote_id`, `poll_id`) VALUES
...
--
-- Table structure for table `com_poll_menu`
--

CREATE TABLE IF NOT EXISTS `com_poll_menu` (
  `pollid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `com_poll_menu`
--
...
--
-- Table structure for table `com_sections`
--

CREATE TABLE IF NOT EXISTS `com_sections` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL DEFAULT '',
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `com_sections`
--

INSERT INTO `com_sections` (`id`, `title`, `name`, `alias`, `image`, `scope`, `image_position`, `description`, `published`, `checked_out`, `checked_out_time`, `ordering`, `access`, `count`, `params`) VALUES
...
--
-- Table structure for table `com_session`
--

CREATE TABLE IF NOT EXISTS `com_session` (
...
--
-- Dumping data for table `com_session`
--

INSERT INTO `com_session` (`username`, `time`, `session_id`, `guest`, `userid`, `usertype`, `gid`, `client_id`, `data`) VALUES
('admin', '1246632748', 'qhcon63nfta62st9p2icnkke03', 0, 62, 'Super Administrator', 25, 1, '__default|a:8:{s:15:"session.counter";i:3;s:19:"session.timer.start";i:1246632734;s:18:"session.timer.last";i:1246632747;s:17:"session.timer.now";i:1246632748;s:22:"session.client.browser";s:84:"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.1) Gecko/20090624 Firefox/3.5";s:8:"registry";O:9:"JRegistry":3:{s:17:"_defaultNameSpace";s:7:"session";s:9:"_registry";a:2:{s:7:"session";a:1:{s:4:"data";O:8:"stdClass":0:{}}s:11:"application";a:1:{s:4:"data";O:8:"stdClass":1:{s:4:"lang";s:0:"";}}}s:7:"_errors";a:0:{}}s:4:"user";O:5:"JUser":19:{s:2:"id";s:2:"62";s:4:"name";s:13:"Administrator";s:8:"username";s:5:"admin";s:5:"email";s:18:"comanova@gmail.com";s:8:"password";s:65:"fd152fc49eebe9bb62199edcbc94c158:4x9NDXZpB95zBICosXx1QcUyjFTBjC40";s:14:"password_clear";s:0:"";s:8:"usertype";s:19:"Super Administrator";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:3:"gid";s:2:"25";s:12:"registerDate";s:19:"2009-07-01 15:44:07";s:13:"lastvisitDate";s:19:"2009-07-02 11:56:28";s:10:"activation";s:0:"";s:6:"params";s:0:"";s:3:"aid";i:2;s:5:"guest";i:0;s:7:"_params";O:10:"JParameter":7:{s:4:"_raw";s:0:"";s:4:"_xml";N;s:9:"_elements";a:0:{}s:12:"_elementPath";a:1:{i:0;s:71:"C:\\wamp\\www\\comanova\\web\\Joomla\\libraries\\joomla\\html\\parameter\\element";}s:17:"_defaultNameSpace";s:8:"_default";s:9:"_registry";a:1:{s:8:"_default";a:1:{s:4:"data";O:8:"stdClass":0:{}}}s:7:"_errors";a:0:{}}s:9:"_errorMsg";N;s:7:"_errors";a:0:{}}s:13:"session.token";s:32:"0867cdcf73adabd66b6638d1f06e33b8";}'),
('', '1246632727', 'djg8ek4ds9us3udsc1u77394t6', 1, 0, '', 0, 0, '__default|a:8:{s:15:"session.counter";i:2;s:19:"session.timer.start";i:1246632711;s:18:"session.timer.last";i:1246632711;s:17:"session.timer.now";i:1246632727;s:22:"session.client.browser";s:84:"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.9.1) Gecko/20090624 Firefox/3.5";s:8:"registry";O:9:"JRegistry":3:{s:17:"_defaultNameSpace";s:7:"session";s:9:"_registry";a:1:{s:7:"session";a:1:{s:4:"data";O:8:"stdClass":0:{}}}s:7:"_errors";a:0:{}}s:4:"user";O:5:"JUser":19:{s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:3:"gid";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:3:"aid";i:0;s:5:"guest";i:1;s:7:"_params";O:10:"JParameter":7:{s:4:"_raw";s:0:"";s:4:"_xml";N;s:9:"_elements";a:0:{}s:12:"_elementPath";a:1:{i:0;s:71:"C:\\wamp\\www\\comanova\\web\\Joomla\\libraries\\joomla\\html\\parameter\\element";}s:17:"_defaultNameSpace";s:8:"_default";s:9:"_registry";a:1:{s:8:"_default";a:1:{s:4:"data";O:8:"stdClass":0:{}}}s:7:"_errors";a:0:{}}s:9:"_errorMsg";N;s:7:"_errors";a:0:{}}s:13:"session.token";s:32:"8b4f5ba86c5358b9256144c606e2deca";}');

-- --------------------------------------------------------

--
-- Table structure for table `com_stats_agents`
--

CREATE TABLE IF NOT EXISTS `com_stats_agents` (
...
--
-- Dumping data for table `com_stats_agents`
--
...
--
-- Table structure for table `com_templates_menu`
--

CREATE TABLE IF NOT EXISTS `com_templates_menu` (
...
--
-- Dumping data for table `com_templates_menu`
--

INSERT INTO `com_templates_menu` (`template`, `menuid`, `client_id`) VALUES
('dark', 0, 0),
('khepri', 0, 1);
...
INSERT INTO `com_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `gid`, `registerDate`, `lastvisitDate`, `activation`, `params`) VALUES
(62, 'Administrator', 'admin', 'comanova@gmail.com', 'fd152fc49eebe9bb62199edcbc94c158:4x9NDXZpB95zBICosXx1QcUyjFTBjC40', 'Super Administrator', 0, 1, 25, '2009-07-01 15:44:07', '2009-07-03 14:52:28', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `com_weblinks`
--

CREATE TABLE IF NOT EXISTS `com_weblinks` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `com_weblinks`
--

INSERT INTO `com_weblinks` (`id`, `catid`, `sid`, `title`, `alias`, `url`, `description`, `date`, `hits`, `published`, `checked_out`, `checked_out_time`, `ordering`, `archived`, `approved`, `params`) VALUES
